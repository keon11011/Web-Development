  ...
  return (
    <div className="relative flex flex-col  bg-clip-border rounded-[.95rem] bg-white">
      <div className="relative flex flex-col  border border-solid border-[#5200FF] rounded-2xl ">
        ...
        {/* <!-- end card header -->
        <!-- card body  --> */}
        <div className="flex-auto px-9 pb-1">
                    ...
                    <div className="inline-flex items-center pl-5">
                      ...
                      >
                        <div className="flex items-center">
                          ...
                          <div className="flex flex-col justify-start">
                            <a href="javascript:void(0)" className="mb-1 ease-in-out"> Product Owner Master className </a>
                          </div>
                        </div>
                      </label>
                    </div>
                    ...
                    <div className="inline-flex items-center pl-5">
                      ...
                      >
                        <div className="flex items-center">
                          ...
                          <div className="flex flex-col justify-start">
                            <a href="javascript:void(0)" className="mb-1 duration-200 ease-in-out"> SQL Advanced className 
                            </a>
                          </div>
                      </div>
                      </label>
