...
const Dashboard = () => {
  ...
  return (
    <main id="Dashboard" className='relative w-full bg-background-secondary flex'>
      ...
      <div id="ContentContainer" className="w-full col-span-6 p-[1.5rem] bg-background-secondary px-[64px] py-[32px] space-y-[24px] max-sm:px-0 max-sm:pl-5 max-sm:w-max">
        <div>
